...
namespace Automated_AI_Video_Processing.ProcessExecution
{
    public class LaunchProcess
    {
        ...
        public ProcessStartInfo getStartInfo
        {
            get
            {
                return selectedProcess.StartInfo;
            }
        }
        ...
        public StreamWriter stdIn
        {
            get
            {
                return selectedProcess.StandardInput;
            }
        }
        ...
        public StreamReader stdErr
        {
            get
            {
                return selectedProcess.StandardError;
            }
        }
        ...
        public StreamReader stdOut
        {
            get
            {
                return selectedProcess.StandardOutput;
            }
        }
        ...
        public bool redirectStdIn
        {
            set
            {
                selectedProcess.StartInfo.RedirectStandardInput = value;
            }
        }
        ...
        public bool redirectStdErr
        {
            set
            {
                selectedProcess.StartInfo.RedirectStandardError = value;
            }
        }
        ...
        public bool redirectStdOut
        {
            set
            {
                selectedProcess.StartInfo.RedirectStandardOutput = value;
            }
        }
